  ...
  return (
    <article className="h-screen flex justify-center items-center">
      <div className="bg-background rounded-2xl shadow-lg border border-front border-opacity-20 p-6 flex flex-col items-center gap-y-2 w-[30vw] relative">
        ...
        <Link
          to="/"
          className="bg-gradient-to-br from-primary to-transparent px-10 py-3 relative overflow-hidden rounded-full font-raleway before:absolute-cover before:bg-primary before:bg-opacity-10"
        >
          Back to Homepage
        </Link>
      </div>
