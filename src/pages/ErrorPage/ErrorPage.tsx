...
export default function ErrorPage() {
  return (
    <article className="flex h-screen items-center justify-center">
      <div className="relative flex w-[30vw] flex-col items-center gap-y-2 rounded-2xl border border-front border-opacity-20 bg-background p-6 shadow-lg">
        <div
        ...
        <Link
          to="/"
          className="before:absolute-cover relative overflow-hidden rounded-full bg-gradient-to-br from-primary to-transparent px-10 py-3 font-raleway before:bg-primary before:bg-opacity-10"
        >
          Back to Homepage
        </Link>
      </div>
